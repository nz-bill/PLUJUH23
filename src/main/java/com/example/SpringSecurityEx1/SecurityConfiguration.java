...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity(prePostEnabled = true)        //aktiverar @PreAuthorized() som kan användas direkt på metoder
                                                    //ett alternativ är annars att ange .hasRole() i filterkedjan
